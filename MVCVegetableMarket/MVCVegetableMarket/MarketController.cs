...
namespace MVCVegetableMarket
{
    internal class MarketController
    {
        ...
        public void GetInput()
        {
            ...
            _model._levPerVegetableKg = double.Parse(Console.ReadLine());
            Console.WriteLine("Enter price for fruits per kg:");
            _model._levPerFruitKg = double.Parse(Console.ReadLine());
            Console.WriteLine("Enter kg of vegetables:");
            _model._totalVegetableKg = int.Parse(Console.ReadLine());
            Console.WriteLine("Enter kg of fruits:");
            _model._totalFruitKg = int.Parse(Console.ReadLine());
        }
